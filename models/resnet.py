...
def conv3x3(in_planes, out_planes, conv_layer, stride=1, groups=1, dilation=1, prune_reg='weight', task_mode='prune'):
...
def conv1x1(in_planes, out_planes, conv_layer, stride=1, prune_reg='weight', task_mode='prune'):
    """1x1 convolution"""
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, conv_layer, stride=1, downsample=None, groups=1,
                 base_width=64, dilation=1, norm_layer=None, prune_reg='weight', task_mode='prune'):
...
class ResNet(nn.Module):
    ...
    def __init__(self, conv_layer, linear_layer, block, layers, num_classes=1000, zero_init_residual=False,
                 ...
                 norm_layer=None, prune_reg='weight', task_mode='prune'):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilate=False, prune_reg='weight', task_mode='prune'):

...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, conv_layer, stride=1, prune_reg='weight', task_mode='prune'):
...
class ResNet(nn.Module):
    def __init__(self, conv_layer, linear_layer, block, num_blocks, num_classes=10, prune_reg='weight', task_mode='prune'):
    ...
    def _make_layer(self, block, planes, num_blocks, stride, prune_reg='weight', task_mode='prune'):
